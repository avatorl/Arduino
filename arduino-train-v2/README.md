# Train compatible with Lego DUPLO (3D-printed parts + Arduino) v.2
...
-   DC motor with 1:48 gear, motor driver DRV8833
-   Ultrasonic distance sensor HC-SR04
-   Tilt sensor SW-520D
-   MCP23008 I2C GPIO expander for the train LED control lines
-   TCS34725 I2C color sensor

### Current LED and color sensor wiring
-   Nano A4/A5: shared I2C bus for MCP23008 and TCS34725
-   MCP23008 GP0-GP2: RGB LED #1 red, green, blue transistor base resistors
-   MCP23008 GP3-GP5: RGB LED #2 red, green, blue transistor base resistors
-   MCP23008 GP6: green LED transistor base resistor
-   Nano D4: TCS34725 breakout LED control input
-   TCS34725 INT: not connected
